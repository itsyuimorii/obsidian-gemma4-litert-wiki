...
const GemmaDemo = (() => {
    ...
    const SCENES = [
        ...
        ['08-improve.html',        'Improve formatting'],
        ['09-wiki-query.html',     'Ask the wiki'],
        ['10-attach.html',         'Attach notes'],
        ['11-skills.html',         'Skills'],
        ['12-not-in-wiki.html',    'Not in the wiki'],
        ['13-save-back.html',      'Save as note'],
        ['14-trust-layers.html',   'Output, not material'],
        ['15-drift.html',          'You edit the note'],
        ['16-provenance.html',     'Provenance'],
        ['17-contradictions.html', 'Contradictions'],
        ['18-review-board.html',   'Review board'],
        ['19-tidy.html',           'Tidy the wiki'],
        ['20-concept-page.html',   'Concept page'],
        ['21-tag-vocab.html',      'Tag vocabulary'],
        ['22-retag.html',          'Retag'],
        ['23-offline.html',        'Pull the cable'],
    ];
