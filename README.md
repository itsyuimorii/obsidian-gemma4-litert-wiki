...
<p align="center"><b>Free local AI with Gemma 4 E4B — right inside Obsidian.</b><br><em>A Karpathy-pattern LLM wiki, running entirely in Obsidian's own process via LiteRT-LM + WebGPU.</em></p>
